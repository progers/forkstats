// This file has both average commits per day and commits per day split out by organization.
...
function showAverageCommitsByDay() {
  var svg = d3.select("#averageCommitsByDay").append("svg")
  ...
  d3.csv("averageCommitsByDay.csv", function(error, data) {
    ...
    svg.append("g")
      ...
      .append("text")
        ...
        .text("Commits per day (30-day moving average)");
...
function showAverageCommitsByDayByOrganization() {
  var svg = d3.select("#averageCommitsByDayByOrganization").append("svg")
      .attr("viewBox", "0 0 " + (width + margin.left + margin.right) + " " + (height + margin.top + margin.bottom))
      .attr("preserveAspectRatio", "xMidYMid")
      .attr("width", "100%")
      .attr("height", "350px")
...
document.addEventListener("DOMContentLoaded", showAverageCommitsByDay);
document.addEventListener("DOMContentLoaded", showAverageCommitsByDayByOrganization);